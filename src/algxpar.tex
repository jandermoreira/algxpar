...
\NewDocumentEnvironment{macro*}{ m m o }{
    ...
    \begin{tcolorbox}[
        ...
        enhanced jigsaw,
        breakable,
    % attach boxed title to top left = {xshift = -2em},
...
\begin{tcblisting}{}
    \begin{algorithmic}
        \While{\textit{condition}}[tested \textbf{before}]
            \Statep{Some command}
...
Also are provided:
\begin{macro}{Input}[~\Argument{text}]
    Inputs.
\end{macro}
\begin{macro}{Output}[~\Argument{text}]
    Outputs
\end{macro}
